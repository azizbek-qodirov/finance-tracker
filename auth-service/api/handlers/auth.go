...
func (h *HTTPHandler) Register(c *gin.Context) {
	...
	if h.US.IsEmailExists(req.Email) != nil {
	...
	c.JSON(http.StatusOK, gin.H{"message": "Your account has been registered. Please check your email for a confirmation link. You have 5 minutes to confirm your account."})
}
